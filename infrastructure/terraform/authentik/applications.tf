...
module "oauth2-komga" {
  source             = "./oauth2_application"
  name               = "Komga"
  icon_url           = "https://raw.githubusercontent.com/walkxcode/dashboard-icons/main/svg/komga.svg"
  launch_url         = "https://komga.exelent.click"
  description        = "Comics, mangas, BDs, magazines and eBooks"
  newtab             = true
  group              = "Selfhosted"
  auth_groups        = [authentik_group.users.id]
  authorization_flow = resource.authentik_flow.provider-authorization-implicit-consent.uuid
