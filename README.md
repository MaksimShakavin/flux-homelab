...
|                                                                                                                                | Name                                                                        | Description                                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/proxmox.svg">                      | [Proxmox](https://www.proxmox.com)                                          | Virtualization platform hosting the Talos VMs                                                          |
| <img width="32" src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/talos.png">                                   | [Talos Linux](https://www.talos.dev/)                                       | Immutable, Kubernetes-focused Linux distribution running on all nodes                                  |
...
| <img width="32" src="https://github.com/cncf/artwork/raw/main/projects/envoy/icon/color/envoy-icon-color.svg">                 | [Envoy Gateway](https://gateway.envoyproxy.io/)                             | Gateway API ingress controller (replaced ingress-nginx).                                               |
...
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/authentik.svg">                    | [Authentik](https://goauthentik.io/)                                        | Self-hosted identity provider for SSO / OIDC across services.                                          |
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/cloudflare.svg">                   | [Cloudflared](https://github.com/cloudflare/cloudflared)                    | Enables Cloudflare secure access to certain ingresses.                                                 |
...
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/longhorn.svg">                     | [Longhorn](https://longhorn.io)                                             | Cloud native distributed block storage for Kubernetes                                                  |
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/garage.svg">                       | [Garage](https://garagehq.deuxfleurs.fr/)                                   | S3-compatible object storage for backups and app buckets.                                              |
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/kopia.svg">                        | [Kopiur](https://github.com/home-operations/kopiur)                         | PVC backup and restore via Kopia to Garage S3.                                      |
...
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/victorialogs.svg">                 | [VictoriaLogs](https://docs.victoriametrics.com/victorialogs/)              | Fast, cost-effective log database and aggregation system (replaced Loki).                              |
| <img width="32" src="https://raw.githubusercontent.com/homarr-labs/dashboard-icons/main/svg/renovate.svg">                     | [Renovate](https://github.com/renovatebot/renovate)                         | Automated dependency updates for Docker images, Helm charts and Terraform.                             |
